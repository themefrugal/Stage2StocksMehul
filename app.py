...
_FALLBACK_CONSTITUENTS = [
    "3MINDIA", "AARTIDRUG", "AARTISOL", "ABMINTL", "ACC", "ADANIENT", "ADANIPORTS",
    "ADANIPOWER", "ATUL", "AUROPHAR", "BAJAJELEC", "BALKRISIND", "BANARBEADS",
    "BANKBARODA", "BASF", "BEML", "BEL", "BHARATFORG", "BHARTIARTL", "BIOCON",
    "BLUESTARCO", "BOMDYEING", "BPCL", "BRITANNIA", "CADILAHC", "CANBK", "CASTROLIND",
    "CEATLTD", "CENTURYTEX", "CGL", "CHAMBLFERT", "CIPLA", "COALINDIA", "COLPAL",
    "CONCOR", "CUMMINSIND", "DABUR", "DALBHARAT", "DIVISLAB", "DIXON", "DLF",
    "DRREDDY", "EICHERMOT", "EMAMILTD", "ENDURANCE", "EXIDEIND", "FEDERALBNK",
    "GAIL", "GLENMARK", "GODREJCP", "GODREJIND", "GRANULES", "GRASIM", "GUJALKALI",
    "HCLTECH", "HDFCBANK", "HDFCLIFE", "HEROMOTOCO", "HEXAWARE", "HINDALCO",
    "HINDPETRO", "HINDUNILVR", "IBULHSGFIN", "ICICIBANK", "ICICIPRULI", "IDEA",
    "IDFCFIRSTB", "IEX", "IGL", "INDIAMART", "INDUSINDBK", "INFY", "INTELLECT",
    "IOC", "IRFC", "ITC", "JINDALSTEL", "JKCEMENT", "JKPAPER", "JSWENERGY",
    "JSWSTEEL", "JUBLFOOD", "JUBLPHARMA", "KOTAKBANK", "LAURUSLABS", "LICHSGFIN",
    "LT", "LTI", "LUPIN", "M&M", "MANAPPURAM", "MARICO", "MARUTI", "MCDOWELL-N",
    "MCX", "MFSL", "MGL", "MINDACORP", "MMTC", "MOIL", "MOTHERSUMI", "MPHASIS",
    "MRF", "MUTHOOTFIN", "NATIONALUM", "NAUKRI", "NAVNETEDUL", "NESTLEIND",
    "NHPC", "NIFTYBEES", "NMDC", "NTPC", "OFSS", "OIL", "ONGC", "PAGEIND",
    "PEL", "PETRONET", "PFC", "PHOENIXLTD", "PIDILITIND", "PNBHOUSING", "PNB",
    "POLYCAB", "POWERGRID", "PRAJIND", "RAIN", "RAMCOCEM", "RBLBANK", "RECLTD",
    "RELIANCE", "SAIL", "SBICARD", "SBIN", "SHREECEM", "SIEMENS", "SRF",
    "SRTRANSFIN", "SUNPHARMA", "SUNTV", "SYMBIOTIC", "TATACHEM", "TATACONSUM",
    "TATAMOTORS", "TATAPOWER", "TATASTEEL", "TCS", "TECHM", "TIINDIA", "TITAN",
    "TORNTPHARM", "TORNTPOWER", "TRENT", "TVSMOTOR", "UBL", "ULTRACEMCO",
    "UNOMINDA", "UPL", "VEDL", "VOLTAS", "WIPRO", "YESBANK", "ZEEL", "SUZLON",
    "TATAELXSI", "ZOMATO", "PBANK", "SAREGAMA", "DELHIVERY", "HAPPSTMNDS",
    "NYKAA", "PAYTM", "LATENTVIEW", "DRAGONFLY", "DIXON", "CLEAN", "V Guard"
]
